...
export async function POST(request: Request) {
  ...
  if (existingEvents.length === 0) {
    ...
    const seedEvents = [
      ...
      },
      {
        ...
        description: "Sconto 20% su tutti gli articoli sportivi allo Sportway. Codice: SPORTWAY20",
      ...
      },
      {
        ...
        description: "Sconto 10% sull'iscrizione alla Milano City Marathon. Codice: MILANO10",
  ...
  return NextResponse.json({
    ...
    eventsInserted: existingEvents.length === 0 ? 7 : 0,
