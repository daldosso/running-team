...
import { removeEventParticipant } from "@/app/actions/events";
          ...
          {participants.map((p) => (
            ...
            >
              ...
              <td className="px-4 py-3">
                <form
                  action={async () => {
                    await removeEventParticipant(eventId, p.memberId);
                  }}
                  onSubmit={(e) => {
                    if (!confirm("Rimuovere questo partecipante?")) e.preventDefault();
                  }}
                >
                  <button
                    type="submit"
